    ...
    internal class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 4, CategoryId = 2, Name = "Kitap 1", Price = 800, Stock = 80, CreatedDate = DateTime.Now },
                new Product { Id = 5, CategoryId = 2, Name = "Kitap 2", Price = 900, Stock = 40, CreatedDate = DateTime.Now }
                );
        }
    }
}
